...
import { X, Volume2, Bell, AlertCircle, RotateCcw } from 'lucide-react'
import { supabase } from '../lib/supabase'

export default function NotificationPreferencesModal({ isOpen, onClose, session, onSettingsChange }) {
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={loading}
                className="bg-yellow-600 hover:bg-yellow-700 disabled:bg-yellow-700 disabled:opacity-50 text-white px-6 py-2 rounded-lg font-medium transition-colors"
              >
