...
const ProTimerApp = () => {
  ...
  const [selectedTimerFromOverview, setSelectedTimerFromOverview] = useState(null);
  ...
  const setActiveTimer = (timerId) => {
    ...
    // If coming from overview, switch to admin view
  ...
  const PresenterView = () => (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-8 relative">
      ...
      <div className="text-center">
        <div className="text-[20vw] font-mono font-bold text-red-500 mb-8 leading-none">
          {formatTime(activeTimer?.timeLeft || 0)}
        </div>
